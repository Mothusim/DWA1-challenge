...
document.querySelector('[data-list-button]').addEventListener('click', () => {
  ...
  function createlistItemClick(matches, authors) {
  ...
  const listItemClickHandler = createlistItemClick(books, authors);
  document.querySelector('[data-list-items]').addEventListener('click', listItemClickHandler);
